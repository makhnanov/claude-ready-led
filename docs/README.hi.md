...
पता पहले `CLAUDE_LED_URL` से, फिर `~/.claude-led.conf` से, और आख़िर में
`http://claude-led.local` से लिया जाता है। स्क्रिप्ट हमेशा 0 के साथ बाहर निकलती है और
2 सेकंड से ज़्यादा कभी अटकती नहीं — इसीलिए इसे हुक पर लगाना सुरक्षित है: बंद पड़ा या
पहुँच से बाहर बोर्ड Claude Code को न धीमा करेगा, न तोड़ेगा।
